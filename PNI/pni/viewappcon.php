...
<div class="col-3">
<a href="pni_confirmed.php">
<input type="submit" id="Button1" name="confirm_butn" value="BACK" style="display:inline-block;width:117px;height:39px;z-index:49;"  style="text-align: center;">
</a>
</div>
